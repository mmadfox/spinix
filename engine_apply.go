...
//			//}
//		case LINE, MULTI_LINE, CIRCLE, POINT, MULTI_POINT,
//			POLY, MULTI_POLY, FUT_COLLECTION, COLLECTION, RECT:
//			//onDistanceObject = &ObjectOnDistanceLit{
...
//	//	onDistanceDevice.DistanceMeters = meters
//	//	return onDistanceDevice, nil
//	//}
//	//
//	//if onDistanceObject != nil {
//	//	onDistanceObject.DistanceMeters = meters
...
//		//		if err := e.devices.Nearby(ctx, deviceCoord[0], deviceCoord[1], typ.DistanceMeters,
...
//		//			if object.Data.Distance(point) <= typ.DistanceMeters {
//		//				counter++
//		//			}
//		//		}
//		//	}
